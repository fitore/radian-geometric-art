...
- **Start from the problem.** The clearer the problem statement, the more obvious the solution. If the solution isn't obvious, the problem statement isn't clear enough.

- **Specific statements create alignment; generic statements create the illusion of alignment.** Be opinionated. Show your work. The best strategies feel too obvious — that's how you know they're right.
